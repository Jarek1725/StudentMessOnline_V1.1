...
public class SearchForUser {
    public static List<userToReturn> searchForUser(String searchedString, String currentUserId, String currUserClass){
        ...
        try{
            ...
            preparedStatement = conn.prepareStatement("SELECT * FROM `user` WHERE CONCAT(first_name,' ',last_name) LIKE ? LIMIT 30");
